...
public class Stepdefs {
    ...
    @Then("the {string} message is issued a")
    public void the_message_is_issued_a(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @Given("the User is not currently a memeber of the the FitBoi application b")
    public void the_User_is_not_currently_a_memeber_of_the_the_FitBoi_application_b() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    @Then("the {string} message is issued b")
    public void the_message_is_issued_b(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @Given("the User is not currently a memeber of the the FitBoi application c")
    public void the_User_is_not_currently_a_memeber_of_the_the_FitBoi_application_c() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    @Then("the {string} message is issued c")
    public void the_message_is_issued_c(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
}